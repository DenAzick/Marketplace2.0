...
using Marketplace.Services.Products.FileService;
...
public class ProductManager
{
    ...
    public async Task<ProductModel> AddProduct(CreateProductModel model)
    {
        var product = new Product
        {
            ...
            Photo_Path = FileService.FileService.ProductImages(model.PhotoFile!)
        };
    ...
    public async Task<ProductModel> UpdateProduct(Guid productId, CreateProductModel model)
    {
        ...
        product.Photo_Path = FileService.FileService.ProductImages(model.PhotoFile!);
