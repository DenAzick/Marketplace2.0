...
public class UserManager
{
    ...
    {
        var user = await _dbContext.Users.FirstOrDefaultAsync(u => u.Id == updateUserModel.Id);
        if (user == null)
        {
        ...
        user.PasswordHash = new PasswordHasher<User>().HashPassword(user, updateUserModel.Password);
